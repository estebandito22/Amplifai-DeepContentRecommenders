...
class TrueDcueNetMelTrunc1DMultiBn(nn.Module):
    ...
    def __init__(self, dict_args):
        ...
        Args
            dict_args: dictionary containing the following keys:
                hidden_size: the output size of the network.  Corresponds to
                    ...
                    users and songs.
        """
        super(TrueDcueNetMelTrunc1DMultiBn, self).__init__()
        ...
        self.outsize = [self.hidden_size, [33, 8, 2, 1]]
    ...
    def forward(self, x):
        ...
        return [tp1, tp2, tp3, tp4]  # (list) batch_size x context_dim (self.hidden_size) x context_size (time dim)
