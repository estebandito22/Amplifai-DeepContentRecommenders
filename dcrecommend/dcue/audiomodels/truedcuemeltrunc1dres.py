...
class TrueDcueNetMelTrunc1DRes(nn.Module):
        ...
        Args
            dict_args: dictionary containing the following keys:
                hidden_size: the output size of the network.  Corresponds to
                    ...
                    users and songs.
        """
        super(TrueDcueNetMelTrunc1DRes, self).__init__()
    ...
    def forward(self, x):
        ...
        out = torch.cat([tp1, tp2, tp3, tp4], dim=2)

        return out  # batch_size x context_dim (self.hidden_size) x context_size (4)
