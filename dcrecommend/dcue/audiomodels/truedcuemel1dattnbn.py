...
class TrueDcueNetMel1DAttnBn(nn.Module):
    ...
    def __init__(self, dict_args):
        ...
        Args
            dict_args: dictionary containing the following keys:
                hidden_size: the output size of the network.  Corresponds to
                    ...
                    users and songs.
        """
        super(TrueDcueNetMel1DAttnBn, self).__init__()
        ...
        self.outsize = [self.hidden_size, 6]
    ...
    def forward(self, x):
        ...
        return torch.cat([tp1, tp2, tp3, tp4, tp5, x], dim=2)  # batch_size x context_dim (self.hidden_size) x context_size (time dim)
