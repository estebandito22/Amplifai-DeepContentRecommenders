...
class AttentionMechanism(nn.Module):
    ...
    def forward(self, seqlen, hidden, contextvects):
        """Forward pass."""
        contextvects = contextvects.permute(2, 0, 1)
        batch_size = contextvects.size(1)
        ...
        for i in range(seqlen):
            ...
            hidden_proj = self.hiddenproj(hidden)
            ...
            context[i] = torch.tanh(self.outputproj(torch.cat((c, hidden), dim=1)))
